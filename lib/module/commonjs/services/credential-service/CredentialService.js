...
CredentialService.getDragonchainCredentials = (dragonchainId) => {
    ...
    try {
        ...
        const authKey = fs_1.readFileSync(`/var/openfaas/secret/sc-${process.env.SMART_CONTRACT_ID}-auth-key`, 'utf-8');
        const authKeyId = fs_1.readFileSync(`/var/openfaas/secret/sc-${process.env.SMART_CONTRACT_ID}-secret-key-id`, 'utf-8');
