...
class DragonchainClient {
    ...
    constructor(dragonchainId = '', verify = true, injected = {}) {
         ...
         */
        this.updateSmartContract = (txnType, image, cmd, executionOrder, desiredState, args, env, secrets, seconds, cron, auth) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const body = {
                version: '3',
            ...
            if (auth)
                body['auth'] = auth;
            return yield this.put(`/contract/${txnType}`, body);
        });
        /**
        ...
        this.createContract = (body) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.post(`/contract/${body.txn_type}`, body);
        });
        /**
